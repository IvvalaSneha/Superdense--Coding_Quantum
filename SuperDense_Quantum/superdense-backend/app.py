...
def run_ibm_simulation(message: str, shots: int = 1024):
    ...
    try:
        IBM_QUANTUM_TOKEN = os.getenv("IBM_QUANTUM_TOKEN", "CqlCP3nMlThUV5L6Wrufq9lor3LTKNqoQs9i60XM8Jg8")
        IBM_INSTANCE = os.getenv("IBM_INSTANCE", "crn:v1:bluemix:public:quantum-computing:us-east:a/ef2798933f624a98bd20d07f7607cb85:6459a87c-68a6-4e61-ad46-80b160a17dc6::")
